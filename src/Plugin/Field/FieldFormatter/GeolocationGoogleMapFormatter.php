 ...
 * )
 *
 * @property \Drupal\geolocation\Plugin\geolocation\MapProvider\GoogleMaps $mapProvider
 */
class GeolocationGoogleMapFormatter extends GeolocationMapFormatterBase {
  ...
  public function viewElements(FieldItemListInterface $items, $langcode) {
    ...
    $elements['#attached']['drupalSettings']['geolocation']['google_map_url'] = $this->mapProvider->getGoogleMapsApiUrl();
