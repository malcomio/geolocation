...
(function ($, Drupal) {
   ...
   */
  Drupal.behaviors.geolocationCommonMapBaidu = {
    /**
      ...
      $.each(
        ...
        function (mapId, commonMapSettings) {
          if (
            ...
            if (map.container.hasClass('geolocation-common-map-baidu-processed')) {
              return;
            }
            map.container.addClass('geolocation-common-map-baidu-processed');
